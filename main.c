...
const unsigned char peer_one[MAC_SIZE] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
const unsigned char peer_two[MAC_SIZE] = {0x02, 0x02, 0x02, 0x02, 0x02, 0x02};
...
int main(int argc, char* argv[]){
		...
		unsigned char dst[MAC_SIZE] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff};
